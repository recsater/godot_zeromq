...
@export var zmq_in_address:String = "tcp://localhost:5556"
@export var zmq_out_address:String = "tcp://localhost:5556"
@export var zmq_in_socket_type:ZMQ.SocketType = ZMQ.SocketType.PULL
@export var zmq_out_socket_type:ZMQ.SocketType = ZMQ.SocketType.PUSH
